...
export const SidebarFooter = () => {
  ...
  return (
    <Stack className="mx-auto py-0" align="center" gap="2">
      {/* <Box>
        ...
        {/* <DropdownMenu.Root>
                <Tooltip content="Options" side='right'>
                    <DropdownMenu.Trigger disabled>
                        <IconButton disabled aria-label='Options' color='gray' variant='ghost' className='p-0 bg-transparent hover:bg-transparent'>
                            <UserAvatar
                                src={myProfile?.user_image}
                                alt={myProfile?.full_name}
                                size='2'
      ...
      <SetCustomStatusModal
        ...
        onOpenChange={setUserStatusModalOpen}
      />
    </Stack>
  );
};